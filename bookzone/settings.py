...
# If I have SQL in env.py will take it otherwise it will use sqlite3 local
...
# AWS Configuration adapted to Django 5.2
if 'USE_AWS' in os.environ:
    ...
    # Modern storage format required by Django 5.2
    STORAGES = {
        "default": {
